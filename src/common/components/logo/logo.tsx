...
const Logo:React.FC<LogoProps> = (props) => {
  ...
  const logo = (
    <svg id="logo" className={cx(theme)} enableBackground="new 0 0 1081.6 1081.8" version="1.1" viewBox="0 0 1081.6 1081.8" xmlns="http://www.w3.org/2000/svg">
  ...
  const text = (
    <text className={cx('author', theme)}>
